...
int main()
{
	...
	std::vector<test> const tests
	{
		...
		{{0b11111111, 0b11000000}, 10},
		{{0b11111111, 0b11100000}, 11},
		{{0b11111111, 0b11110000}, 12},
		{{0b11111111, 0b11111000}, 13},
		{{0b11111111, 0b11111100}, 14},
		{{0b11111111, 0b11111110}, 15},
		{{0b11111111, 0b11111111}, 0},
		{{0b11111111, 0b11111111, 0b00000000}, 0},
		{{0b11111111, 0b11111111, 0b10000000}, 17},
		{{0b11111111, 0b11111111, 0b11000000}, 18},
		{{0b11111111, 0b11111111, 0b11100000}, 19},
		{{0b11111111, 0b11111111, 0b11110000}, 20},
	};
